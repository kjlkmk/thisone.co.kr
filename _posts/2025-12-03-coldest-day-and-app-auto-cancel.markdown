...
date: 2025-12-03
categories: [배송일지, 테크팁]
tags: [한파, 겨울, 인성콜, 오더전략, 자동취소, 퀵서비스, 앱개발]
author: "퀵서비스 기사"
excerpt: "올겨울 최저 기온을 기록한 날, 강한 한파 속에서도 여유를 잃지 않고 업무를 이어갔다. 직접 만든 앱의 '자동 취소' 기능이 빛을 발한 효율적인 하루의 기록."
---
...
## 추울수록 빛나는 '자동 취소' 기능
강남에서 오후 들어 날씨가 더 추워지자 시내 콜이 많이 보였다. 이때 내가 만든 매크로 지지기의 **'자동 취소 지역 설정'** 기능이 더욱 빛을 발했다.

> "자동 취소 지역을 세팅하면 그 지역의 오더는 바로 취소 버튼을 클릭해주는데, 결론은 내가 원하는 지역의 오더만 눈으로 볼 수 있는 것이 아주 좋은 기능이다. 오늘 같은 날은 더 필요한 기능이었다."
